...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, RecGeneratedEvent> consumerFactory() {
        JsonDeserializer<RecGeneratedEvent> deserializer = new JsonDeserializer<>(RecGeneratedEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, RecGeneratedEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, RecGeneratedEvent> factory =
